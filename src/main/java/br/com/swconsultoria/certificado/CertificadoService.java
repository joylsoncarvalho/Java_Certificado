...
public class CertificadoService {
	...
	public static void inicializaCertificado(Certificado certificado, InputStream cacert) throws CertificadoException {
		...
		Optional.ofNullable(certificado)
		...
		try {
			...
			if (certificado.isAtivarProperties()) {
				...
				SocketFactoryDinamico socketFactory = new SocketFactoryDinamico(keyStore, certificado.getNome(),
						certificado.getSenha(), cacert, certificado.getSslProtocol());
	...
	public static Certificado certificadoPfxBytes(byte[] certificadoBytes, String senha) throws CertificadoException {
		...
		Optional.ofNullable(certificadoBytes)
				.orElseThrow(() -> new IllegalArgumentException("Certificado não pode ser nulo."));
	...
	public static Certificado certificadoPfx(String caminhoCertificado, String senha)
			throws CertificadoException, FileNotFoundException {

		Optional.ofNullable(caminhoCertificado)
				.orElseThrow(() -> new IllegalArgumentException("Caminho do Certificado não pode ser nulo."));
		Optional.ofNullable(senha).orElseThrow(() -> new IllegalArgumentException("Senha não pode ser nula."));
	...
	public static Certificado certificadoA3(String marca, String dll, String senha, String alias)
	...
	public static Certificado certificadoA3(String marca, String dll, String senha, String alias, String serialToken)
			throws CertificadoException {
	...
	private static void setDadosCertificado(List<Certificado> listaCert, KeyStore ks, String aliasKey,
			TipoCertificadoEnum tipoCertificadoEnum) throws CertificadoException {
	...
	public static List<String> listaAliasCertificadosA3(String marca, String dll, String senha)
			throws CertificadoException {
	...
	public static X509Certificate getCertificate(Certificado certificado, KeyStore keystore)
			throws CertificadoException {
		try {
	...
	public static Certificado getCertificadoByCnpjCpf(String cnpjCpf) throws CertificadoException {
		return listaCertificadosWindows().stream().filter(cert -> cnpjCpf.equals(cert.getCnpjCpf())).findFirst()
				.orElseThrow(() -> new CertificadoException("Certificado não encontrado com CNPJ/CPF : " + cnpjCpf));
	}

	private static String getDocumentoFromCertificado(Certificado certificado, KeyStore keyStore)
			throws CertificadoException {
